...
PM_START_TEXT = """
**Hi {}**
I am a bot who works for @classy_empire and can detect spammers in groups can protect groups from then
...
async def start(event):
    ...
    if event.is_private:
       await event.reply(PM_START_TEXT.format(event.sender.first_name), buttons=[
        ...
        [Button.url("classy empire", "https://t.me/classy_empire")]])
       return
